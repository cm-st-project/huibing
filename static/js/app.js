...
function search(){
    ...
    success: function(response){
       ...
       // image.src = response // String. You have to covert the result to JSON. You can use this picturesList = JSON.parse(response);
        imagePathList = JSON.parse(response)
        currIndex = 0
